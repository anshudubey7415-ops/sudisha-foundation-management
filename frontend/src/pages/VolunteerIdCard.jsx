...
function VolunteerIdCard() {
  ...
  const downloadPDF = async () => {
    ...
    pdf.addImage(imgData, "PNG", 10, 10, 90, 55);
    pdf.save(`${volunteer.name}_Volunteer_ID.pdf`);
  };

  if (!volunteer) return <h2>Loading...</h2>;

  const qrValue = volunteer.verificationId || volunteer.volunteerId;
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      >
        ...
        <h2>SUDISHA FOUNDATION</h2>
        <h3>VOLUNTEER ID CARD</h3>
        <hr />
