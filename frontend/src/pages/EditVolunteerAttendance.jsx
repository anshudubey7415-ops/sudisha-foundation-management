...
// Styles remain same...
const styles = `
  .eva-page { font-family: "Segoe UI", sans-serif; max-width: 640px; margin: 0 auto; padding: 24px; color: #1e293b; }
  .eva-card { background: #fff; border: 1px solid #e2e8f0; border-radius: 12px; padding: 24px; }
  .eva-card h1 { margin: 0 0 18px; font-size: 22px; }
  .eva-error { color: #dc2626; margin-bottom: 12px; font-size: 14px; }
  .eva-form { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; }
  .eva-field { display: flex; flex-direction: column; gap: 6px; font-size: 13px; font-weight: 600; }
  .eva-field-full { grid-column: 1 / -1; }
  .eva-field input, .eva-field select, .eva-field textarea { padding: 9px 12px; border: 1px solid #cbd5e1; border-radius: 8px; font-size: 14px; outline: none; }
  .eva-actions { grid-column: 1 / -1; display: flex; justify-content: flex-end; gap: 10px; margin-top: 6px; }
  .eva-btn { border: none; border-radius: 7px; padding: 10px 18px; font-size: 14px; font-weight: 600; cursor: pointer; }
